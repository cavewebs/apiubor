...
$matches = $conn->query("SELECT * FROM competitions WHERE com_status !='14'") or die($conn->error);
...
;
          ...
          if ($stmt){
              ...
              // $conns->commit();
              $update_fixtured = $conn->query("UPDATE competitions set com_status='14' WHERE com_id='".$row['com_id']."'");
              if($update_fixtured){
